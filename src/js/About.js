    ...
    render() {
        ...
        return (
            <div id='about' className='hide'>
                ...
                <div className='about-paragraph'>
                    I'm currently a Freshman at the University of Texas at Dallas. Aside from my stellar grades and uncompromising work ethic, I am heavily involved in the Association for Computing Machinery as a Developer.
                </div>
                <div className='about-paragraph'>
                    Since I'm always looking for any opportunity to expand my technical and team-based skills, I'm actively searching for internships for the Summer and Fall of 2021.
                </div>
                <div className='about-paragraph'>
